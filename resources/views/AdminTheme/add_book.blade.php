...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
      <!-- SELECT2 EXAMPLE -->
      <form action="{{route('save1')}}" method="POST" id="admin_form" enctype="multipart/form-data">
        @csrf
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="book" id="book" class="form-control" placeholder="Enter Book Name">
                </div>
                @if($errors->has('book'))
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="quantity" id="quantity" class="form-control" placeholder="Enter Book Quantity">
                </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="author" id="author" class="form-control" placeholder="Enter Book Author Name">
                </div>
            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  <textarea type="text" name="intro" id="intro" class="form-control" placeholder="Enter Book Intro"></textarea>
                </div>
                @if($errors->has('intro'))
